...
covering 1,926 distinct codes, the system achieves **86.7% top-1 accuracy** (E-010 + SupCon Z hybrid)
and automatically codes **88.2% of cases** at high precision,
routing the remainder to human review. It does this without access
...
Z for administrative contacts). This router achieves 96.9% accuracy — nearly
...
results = [
    ...
    {"Experiment": "**E-010 (best)**", "Architecture": "Hierarchical, 40-epoch init",
     "E2E Accuracy": "**85.8%**", "Macro F1": "**0.762**", "ECE": "**0.031**",
     "Coverage@0.7": "**86.4%**", "Note": "Current best"},
    {"Experiment": "E-012 (backbone eval)", "Architecture": "Hierarchical, Clinical ModernBERT",
     "E2E Accuracy": "48.8%", "Macro F1": "0.369", "ECE": "0.078",
     "Coverage@0.7": "37.5%", "Note": "ModernBERT backbone — ClinicalBERT wins"},
    {"Experiment": "E-013 (backbone eval)", "Architecture": "Hierarchical, BioClinical ModernBERT",
     "E2E Accuracy": "7.0%", "Macro F1": "0.046", "ECE": "0.013",
     "Coverage@0.7": "1.7%", "Note": "ModernBERT backbone — catastrophic failure"},
    {"Experiment": "**E-014 + E-010 hybrid**", "Architecture": "Hierarchical + SupCon Z",
     "E2E Accuracy": "**86.7%**", "Macro F1": "**—**", "ECE": "**0.027**",
     "Coverage@0.7": "**88.2%**", "Note": "**Current best — SupCon Z resolver**"},
    {"Experiment": "MIMIC-IV validation", "Architecture": "E-010 on real notes",
     "E2E Accuracy": "12.0%", "Macro F1": "0.069", "ECE": "0.298",
     "Coverage@0.7": "22.7%", "Note": "Real MIMIC-IV discharge summaries — domain shift"},
]
...
3. **Selective automation is viable.** At a 0.7 confidence threshold,
   86.4% of cases are auto-coded at 95.6% precision — a precision level
   that meets or exceeds typical human coding accuracy for common codes.

4. **Domain pretraining beats architectural modernity — confirmed twice.** Both Clinical ModernBERT (E-012: 48.8%) and BioClinical ModernBERT (E-013: 7.0%) were tested and rejected. ClinicalBERT leads by 37–79 percentage points.

5. **The synthetic-to-real gap is 73.8pp and domain-shift driven.** MIMIC-IV validation (n=4,877) yields 12.0% E2E vs 85.8% synthetic. Token truncation is ruled out — the issue is training data, not architecture.

6. **SupCon fine-tuning closes the Z-chapter gap.** The Z-chapter (administrative codes) improved from 62.1% to 83.3% (+21.2pp) using Supervised Contrastive Learning (E-014). The full-system E2E accuracy rose to 86.7%. Feature-similarity problems require contrastive objectives — cross-entropy is insufficient.
...
| **Best result** | 85.8% E2E accuracy, 0.762 Macro F1 |
| **Auto-coding rate** | 86.4% at 95.6% precision (τ = 0.7) |
| **Calibration quality** | ECE = 0.031 (well calibrated) |
| **Codebase** | Python 3.12, HuggingFace Transformers, Polars, uv |
| **Test coverage** | 94 unit tests, no GPU required |
| **Backbone evaluation** | E-012: 48.8% E2E, E-013: 7.0% E2E — ClinicalBERT wins decisively |
| **Z-chapter SupCon (E-014)** | 62.1% → 83.3% (+21.2pp) — feature similarity solved |
| **MIMIC-IV validation** | 12.0% real-world E2E — domain shift gap quantified |
