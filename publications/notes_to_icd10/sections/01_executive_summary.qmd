...
5. **SupCon fine-tuning closes the Z-chapter gap.** The Z-chapter (administrative codes) improved from 62.1% to 83.3% (+21.2pp) using Supervised Contrastive Learning (E-014). The full-system E2E accuracy rose to 86.7%. Feature-similarity problems require contrastive objectives — cross-entropy is insufficient.
