...
covering 1,926 distinct codes, the system achieves **85.8% top-1 accuracy**
and automatically codes **86.4% of cases** at **95.6% precision**,
...
4. **Domain pretraining beats architectural modernity — confirmed twice.** Both Clinical ModernBERT (E-012: 48.8%) and BioClinical ModernBERT (E-013: 7.0%) were tested and rejected. ClinicalBERT leads by 37–79 percentage points. The backbone choice is doubly empirically validated.
