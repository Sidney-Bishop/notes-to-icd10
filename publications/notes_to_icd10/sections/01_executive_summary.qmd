...
4. **Domain pretraining beats architectural modernity.** Replacing ClinicalBERT
   with Clinical ModernBERT (a 2025 model with 8,192-token context, 22 layers,
   MIMIC-IV pretraining) reduced E2E accuracy from 85.8% to 48.8%. The
   ClinicalBERT backbone choice is empirically validated, not merely conventional.
...
| **Backbone evaluation** | E-012: Clinical ModernBERT tested and rejected (48.8% E2E) |
